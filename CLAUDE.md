...
| `internal/runtimeconfig` | 全局运行时配置覆盖持久化（runtime_settings 表 per-section JSON 9 段含 tools+mcp+vad，SaveTx/WithTx 与 secrets 原子写入；启动由 ApplyOverrides 覆盖 config.yaml 基线） | 10 | [CLAUDE.md](./internal/runtimeconfig/CLAUDE.md) |
