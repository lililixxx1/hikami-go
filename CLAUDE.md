...
| `internal/fsutil` | 原子文件写入辅助（WriteFileAtomic/WriteJSONAtomic） | 5 | [CLAUDE.md](./internal/fsutil/CLAUDE.md) |
...
| `internal/notify` | 通知事件与发送器 | 15 | [CLAUDE.md](./internal/notify/CLAUDE.md) |
