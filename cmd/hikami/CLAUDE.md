...
6. `db.Open()` + `db.Migrate()` 初始化 SQLite（当前 32 个版本，含 recap_templates、bili_cookie_accounts、账号关联列、per-channel recap 配置、sessions.archived_at、channels.auto_recap）
...
20. 监听 SIGINT/SIGTERM，10s 超时优雅关闭
